    ...
    <div className="row">
      <div className="col-md-10">
        <div className="ms-5 me-5 mt-3">
          ...
          <h4 className="gender d-flex mt-5 py-3 justify-content-center align-self-end"> Nice to meet you!! <br />
          Thank you for taking the time for apply. </h4>
          <p className="d-flex justify-content-center">Kindly choose your gender and enter your date of birth </p>
